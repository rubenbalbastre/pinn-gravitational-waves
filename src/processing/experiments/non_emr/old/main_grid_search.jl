...
output_directory = "../../01_data/02_output/02_case_2/grid_search/"
...
reg_term_list = [1.0f-2, 1.0f-1, 1.0f0, 1.0f1]
stability_term_list = [1.0f-2, 1.0f-1, 1.0f0, 1.0f1]
pos_ecc_term_list = [1.0f-1, 1.0f0, 1.0f1, 1.5f1, 1.0f2]
dt2_term_list = [5f1, 1.0f2, 5f2, 1.0f3]
dt_term_list = [1.0f2, 5.0f2, 1.0f3, 5.0f3, 1.0f4]
data_term_list = [1.0f-2, 1.0f-1, 1.0f0, 1.0f1]
        ...
        for pos_ecc_term in pos_ecc_term_list
            for dt2_term in dt2_term_list
                for dt_term in dt_term_list
                    for data_term in data_term_list
                        ...
                        if isfile(metrics_dir*"losses.csv")
                            ...
                            if size(filter(:test_name => ==(test_name_i), x),1) == 0
                                ...
                                if save_data
                                    ...
                                    test_name = "regterm_" * string(reg_term) * "__stability_term_" * string(stability_term) * "__pos_ecc_term_" * string(pos_ecc_term) * "__dt2_term_" * string(dt2_term) * "__dt_term_" * string(dt_term) * "__data_term_" * string(data_term)
