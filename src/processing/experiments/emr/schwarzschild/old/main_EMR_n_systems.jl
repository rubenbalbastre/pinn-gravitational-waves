...
p_array = [80, 100, 120, 150] # [50, 60, 75, 90, 100, 110, 125, 140, 150]
e_array = [0.2, 0.3, 0.1, 0.6, 0.5, 0.4, 0.7]# [0.3, 0.6, 0.7, 0.5, 0.4, 0.3, 0.2, 0.1] # [0.05, 0.10, 0.2, 0.3, 0.5, 0.6, 0.7, 0.8]
M_array = [1.0]
