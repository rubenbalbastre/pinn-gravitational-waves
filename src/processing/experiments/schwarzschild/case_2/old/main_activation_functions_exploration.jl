...
n_neurons = 32;
# tanh, cos, softmodulusQ, sigmoid, relu, leakyrelu
for activation_function in [leakyrelu]
    test_name = "architecture_1_act__"*string(activation_function)*"/"
    output_directory = "../../01_data/02_output/02_case_2/1_system/"
    output_dir = output_directory*test_name

    # MODEL
    @info "Defining model"
    nn_output = nn_model_case2(model_name, n_neurons, activation_function)
    global NN_params
    ...
    epochs_increments = [50,50,50,50,50,50,50,50,100,150]
