...
function h_22_quadrupole_two_body(
    dt, orbit1, mass1, orbit2, mass2)
    #=
...
function interpolate_time_series(tsteps, tdata, fdata)
    #=
    Interpolate time series to adapt the wave form length
    =#
